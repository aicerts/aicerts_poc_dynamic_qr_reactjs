...
const Search = () => {
  ...
  return (
    <div>
      ...
      <div className='admin-search-container mt-5'>
        <select className="search-input" value={searchMode} onChange={(e) => setSearchMode(e.target.value)}>
      ...
      <div className="certificate-list mt-5">
        <ul>
          {certData && certData.map((link, index) => {
            ...
            return (
              <div key={index} className="certificate-info">
                ...
                <a href={link} download={fileName} className="download-link">
                  <Image
